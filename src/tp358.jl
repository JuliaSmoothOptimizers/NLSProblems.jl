...
function tp358()
  ...
  t = [10*(i - 1) for i=1:33]
  y = Array{Float64}(33)
  y[1:11]  = [0.844; 0.908; 0.932; 0.936; 0.925; 0.908; 0.881; 0.850; 0.818; 0.784; 0.751]
  y[12:22] = [0.718; 0.685; 0.658; 0.628; 0.603; 0.580; 0.558; 0.538; 0.522; 0.506; 0.490]
  y[23:33] = [0.478; 0.467; 0.457; 0.448; 0.438; 0.431; 0.424; 0.420; 0.414; 0.411; 0.406]
